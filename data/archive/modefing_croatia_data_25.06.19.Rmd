...
biob$size.notake=biob$size.notake[biob$site == "Brijuni"] <- 2651
biob$yr.creation=biob$yr.creation[biob$site == "Brijuni"] <- 1983
biob$age.reserve.yr=biob$age.reserve.yr[biob$site == "Brijuni"] <- 35
biob$total.mpa.ha=biob$total.mpa.ha[biob$site == "Brijuni"] <- 2651

biob$total.mpa.ha=biob$total.mpa.ha[biob$site == "Kornati"] <- 16600
biob$yr.creation=biob$yr.creation[biob$site == "Kornati"] <- 1980
biob$age.reserve.yr=biob$age.reserve.yr[biob$site == "Kornati"] <-38

biob$total.mpa.ha=biob$total.mpa.ha[biob$site == "Miljet"] <- 2375
biob$yr.creation=biob$yr.creation[biob$site == "Miljet"] <- 1960
biob$age.reserve.yr=biob$age.reserve.yr[biob$site == "Miljet"] <-57
...
biob=biob%>%
  select(-Trip.date,-Start.time,-End.time,-Sea.condition,-DepthRange,-Time,-Right.observer,
